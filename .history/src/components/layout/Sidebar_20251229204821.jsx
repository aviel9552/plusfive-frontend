  ...
  return (
    <>
      ...
      <aside className={sidebarClasses}>
       ...
       {/* NAVIGATION */}
<nav
  className="flex-1 overflow-y-auto overflow-x-visible"   // ← מאפשר לטולטיפ לצאת מחוץ לסיידבר
  ...
  <ul className={`${isCollapsed ? "px-0" : "px-2"} space-y-3`}>
    {navLinks.map((link) => (
      <SidebarNavItem
        key={link.to}
        {...link}
        isCollapsed={isCollapsed}   // ← זה מה שמפעיל את הטולטיפ בקובץ SidebarNavItem
        isRTL={isRTL}
      />
    ))}
  </ul>
