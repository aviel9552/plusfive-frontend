...
const SidebarNavItem = ({
  ...
  const [tooltipY, setTooltipY] = useState(null); // גובה הטולטיפ (ביחס למסך)
  const itemRef = useRef(null);                  // ref לאייטם בסיידבר
  ...
  return (
    <>
      ...
      {/* טולטיפ מעוצב – בגובה האייקון, במקביל אליו, לא נחתך */}
