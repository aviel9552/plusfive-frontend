        ...
        >
          ...
          >
            {label}
                       ...
                       {/* טולטיפ מעוצב – מיושר בדיוק במקביל לאייקון */}
      {isHovered && isCollapsed && (
        <div
          className={`
            absolute
            top-1/2 -translate-y-1/2   /* יישור בדיוק למרכז האייקון */
            ${isRTL ? 'right-[60px]' : 'left-[60px]'}  /* מרחק אופקי מהאייקון */
