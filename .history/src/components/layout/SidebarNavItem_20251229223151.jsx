...
const SidebarNavItem = ({
  ...
  const [tooltipY, setTooltipY] = useState(null); // הגובה של הטולטיפ במסך
  ...
  // כשהעכבר נכנס – מחשבים את המרכז של האייטם וממקמים שם את הטולטיפ
  ...
  return (
    <>
      ...
      {/* טולטיפ מעוצב – fixed, בגובה האייקון, מקביל אליו */}
      {isHovered && tooltipY !== null && (
        <div
          className={`
            fixed
