...
const renderWaitlistAddClientPanel = () => {
  ...
  // יומן בתוך הפופאפ – RTL אמיתי (א' מימין, ש' משמאל)
  const renderBookingMonthForPanel = () => {
    ...
    for (let week = 0; week < 6; week++) {
      const start = week * 7;
      const weekDays = days.slice(start, start + 7).reverse();
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        dir="rtl"
        className="
          relative h-screen w-[380px] sm:w-[480px]
          bg-white dark:bg-[#111]
          border-l border-gray-200 dark:border-commonBorder
          shadow-2xl
          flex flex-col
          calendar-slide-in
          text-right
      ...
      >
        ...
        <button
          className="
            absolute -left-10 top-7 w-8 h-8 rounded-full
            bg-white dark:bg-[#111]
            border border-gray-200 dark:border-commonBorder
            shadow-md
            flex items-center justify-center
            text-gray-500 hover:bg-gray-50 dark:hover:bg-[#222]
          "
          onClick={closePanel}
        >
          <FiX className="text-[20px]" />
        ...
        <div className="px-8 pt-7 pb-3">
          {/* שלבי הפלואו */}
          <div className="text-[11px] mb-2 flex items-center gap-1 justify-start">
            <button
        ...
        <div className="flex-1 overflow-y-auto px-8 pb-6 space-y-6">
            ...
            <>
              <div className="relative mt-2">
                <input
                  ...
                  placeholder="חפש לקוח או השאר ריק ללקוח מדומה"
                  className="
                    w-full rounded-full border border-gray-200 dark:border-[#2b2b2b]
                    bg-white dark:bg-[#181818]
                    px-4 py-2.5 text-[13px]
                    text-gray-800 dark:text-gray-100
                    placeholder:text-gray-400 dark:placeholder:text-gray-500
                    focus:outline-none focus:ring-2 focus:ring-[rgba(255,37,124,0.4)]
                  "
                />
              </div>
              ...
              <div className="mt-4 space-y-2">
                ...
                >
                  <span className="flex items-center gap-3">
                    <span className="w-8 h-8 rounded-full bg-[rgba(255,37,124,0.08)] flex items-center justify-center text-[20px]">
                      +
                    </span>
                    <span className="flex flex-col items-start">
                      ...
                      <span className="text-[11px] text-gray-500 dark:text-gray-400">
                        צור פרופיל לקוח חדש ישירות מהיומן
                      </span>
                    </span>
                  </span>
                </button>
                ...
                {filteredClients.map((c) => (
                  <button
                    ...
                    "
                    onClick={() => {
                      setSelectedWaitlistClient(c);
                      setWaitlistAddStep('date');
                    }}
                  >
                    <span className="flex items-center gap-3 flex-row-reverse">
                      <span className="w-8 h-8 rounded-full bg-[#f1f5f9] dark:bg-[#1f2933] flex items-center justify-center text-[13px]">
                        {c.name?.[0] || 'ל'}
                      </span>
                      <span className="flex flex-col items-start">
                        <span className="font-medium text-gray-900 dark:text-gray-100">
          ...
          {isDateStep && (
            <div className="space-y-4">
              <div className="text-[13px] text-gray-600 dark:text-gray-300">
                <span className="font-medium">תאריך שנבחר:</span>{' '}
              ...
              <div className="flex justify-start mt-4">
                <button
                  className="
                    ...
                    bg-[rgba(255,37,124,1)] text-white text-[13px] font-medium
                    hover:bg-[rgba(255,37,124,0.9)]
                  "
                  onClick={() => setWaitlistAddStep('time')}
                >
                  המשך לשעה
          ...
          {isTimeStep && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {timeSlots.map((slot) => {
                  const isSelected = bookingSelectedTime === slot.value;
                  return (
                    <button
                      key={slot.value}
                      className={`
                        px-3 py-2 rounded-full text-[12px]
                        border
                        ${
                          isSelected
                            ? 'border-[rgba(255,37,124,1)] bg-[rgba(255,37,124,0.08)] text-[rgba(255,37,124,1)]'
                            : 'border-gray-200 dark:border-[#2b2b2b] text-gray-700 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-[#181818]'
                        }
                      `}
                      onClick={() => setBookingSelectedTime(slot.value)}
                    >
                      {slot.label}
                    </button>
                  );
          ...
          {/* שלב 4 – בחירת שירות (דמו בסיסי, תתאים לשירותים האמיתיים שלך) */}
          {isServiceStep && (
            <div className="space-y-4">
              <div className="text-[13px] text-gray-600 dark:text-gray-300">
                בחר שירות מהרשימה (כאן תוכל לשלב את רשימת השירותים האמיתית).
              </div>

              {/* דמו שירותים */}
              <div className="space-y-2">
                {['תספורת', 'תספורת + זקן', 'תספורת ילדים'].map((service) => {
                  const isSelected = bookingSelectedService === service;
                  return (
                    <button
                      key={service}
                      className={`
                        w-full flex items-center justify-between
                        px-4 py-3 rounded-xl border text-[13px]
                        ${
                          isSelected
                            ? 'border-[rgba(255,37,124,1)] bg-[rgba(255,37,124,0.06)] text-[rgba(255,37,124,1)]'
                            : 'border-gray-200 dark:border-[#2b2b2b] text-gray-800 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-[#181818]'
                        }
                      `}
                      onClick={() => setBookingSelectedService(service)}
                    >
                      <span>{service}</span>
                      <span className="text-[11px] text-gray-500 dark:text-gray-400">
                        30 דק׳
              ...
              <div className="flex justify-start mt-4">
                <button
                  ...
                  "
                  onClick={() => {
                    // כאן אתה עושה את השמירה/הוספה לבוקינג בפועל
                    closePanel();
                  }}
                >
                  שמור תור
