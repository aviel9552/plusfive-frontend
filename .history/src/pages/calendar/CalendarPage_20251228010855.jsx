...
const CalendarPage = () => {
  ...
  const renderTimeGrid = () => {
    ...
    if (view === "day") {
      ...
      return (
        <div className="relative flex flex-1 min-h-0">
          ...
          {/* עמודת שעות – DAY VIEW */}
          <div className="w-16 sm:w-14 bg-white dark:bg-[#101010] text-[10px] sm:text-[12px] text-gray-500 dark:text-gray-400">
            ...
            {HOURS.map((h) => (
              <div
                key={h}
                className="flex items-start justify-end pr-1 sm:pr-2 pt-1 font-semibold border-t border-r border-gray-200/80 dark:border-[#1c1c1c] bg-white dark:bg-[#101010]"
    ...
    return (
      <div className="flex flex-1 min-h-0">
        ...
        <div className="w-16 sm:w-14 bg-white dark:bg-[#050505] text-[10px] sm:text-[12px] text-gray-500 dark:text-gray-400">
        ...
        {/* ימים */}
        <div className="flex-1 grid grid-cols-7 bg-white dark:bg-[#050505]">
              ...
              >
                ...
                >
                  ...
                  {(() => {
                    ...
                    if (
                      nowLocal.toDateString() === day.toDateString() &&
                      hourNow >= START_HOUR &&
                      hourNow <= END_HOUR
                    ) {
                      const top = (hourNow - START_HOUR) * slotHeight;
                      return (
                        <div
      ...
      <div className="flex-1 min-h-0 flex flex-col bg-white dark:bg-[#050505]">
        ...
        <div className="grid grid-cols-7 border-b border-gray-200 dark:border-commonBorder bg-gray-50/80 dark:bg-[#080808]">
          {dayNames.map((name) => (
            <div
              key={name}
              className="h-10 flex items-center justify-center text-[11px] font-medium text-gray-500 dark:text-gray-300"
            >
              {name}
            </div>
          ))}
    ...
    return (
      <div className="fixed inset-0 z-40 flex justify-end">
        ...
        >
          ...
          {/* Header */}
          <div className="relative z-20 flex items-center justify-between px-8 py-7">
          ...
          {/* תוכן */}
          <div className="relative z-20 flex-1 overflow-y-auto px-6 pt-2 pb-5 text-sm text-gray-800 dark:text-gray-100">
            {/* שורת פילטרים */}
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <div className="relative">
                ...
                {isWaitlistRangeOpen && (
                  <div
                    className="absolute left-0 mt-2 w-48 rounded-2xl border border-gray-200 dark:border-[#282828] bg-white dark:bg-[#181818] z-30 py-1 text-xs sm:text-sm px-2"
                    style={{
                      boxShadow:
            ...
            <div className="space-y-3">
              {filteredWaitlist.map((item) => (
                <div
                  key={item.id}
                  className="relative rounded-xl border border-gray-200 dark:border-[#282828] bg-white dark:bg-[#181818] p-3 text-xs text-gray-800 dark:text-gray-100"
                >
                  ...
                  <div className="flex justify-between items-center text-[11px]">
                    <span className="capitalize text-gray-500">
                      {item.status === "upcoming" ? "ממתין" : item.status === "expired" ? "פג תוקף" : "נקבע תור"}
                    </span>
                  ...
                  <div className="mt-3 flex justify-end">
                    <div className="relative">
                      <button
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full border border-gray-200 dark:border-[#2b2b2b] bg-white dark:bg-[#181818] text-[11px] font-medium text-gray-800 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-[#222222]"
                        onClick={(e) => {
                          e.stopPropagation();
  ...
  const renderWaitlistAddClientPanel = () => {
    ...
    // יומן בתוך הפופ אפ – UI כמו המודל, מותאם לפאנל
...
>
  ...
  return (
    <div className="-mt-6 -mx-4 sm:-mx-6 h-[calc(100vh-85px)] flex flex-col bg-white dark:bg-[#111111]">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-gray-200 dark:border-commonBorder bg-[#F9F9F9] dark:bg-[#111111]">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <button
            onClick={handleToday}
            className="px-3 py-1.5 rounded-full border border-gray-200 dark:border-commonBorder text-xs sm:text-sm text-gray-800 dark:text-gray-100 bg-white dark:bg-[#181818] hover:bg-gray-50 dark:hover:bg-[#202020]"
          >
            היום
          </button>
          ...
          <div className="relative">
            ...
            {isStaffDropdownOpen && (
              <div className="absolute left-0 mt-2 w-72 rounded-2xl border border-gray-200 dark:border-[#282828] bg-white dark:bg-[#181818] shadow-lg z-30 text-xs sm:text-sm text-gray-800 dark:text-gray-100">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 justify-end flex-shrink-0">
          ...
          {/* Day / Week / Month */}
          <div className="inline-flex items-center rounded-full bg-gray-100 dark:bg-[#181818] p-1 text-xs sm:text-sm">
            <button
              onClick={() => {
                setView("day");
                setCustomWeekStart(null);
...
{isNewClientModalOpen && (
  <div className="fixed inset-0 z-50 flex justify-end" dir="ltr">
    ...
    {/* הפאנל עצמו – יושב בצד ימין כמו באנגלית */}
    <div
      className="relative h-screen w-[380px] sm:w-[480px] bg-white dark:bg-[#111] border-l border-gray-200 dark:border-commonBorder shadow-2xl flex flex-col calendar-slide-in z-50"
      onClick={(e) => e.stopPropagation()}
    >
      <button
        className="absolute -left-10 top-7 w-8 h-8 rounded-full bg-white dark:bg-[#111] border border-gray-200 dark:border-commonBorder shadow-md flex items-center justify-center text-gray-500 hover:bg-gray-50 dark:hover:bg-[#222]"
