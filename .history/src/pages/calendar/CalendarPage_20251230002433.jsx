  ...
  {orderedStaff.map((staff) => {
    ...
    return (
      ...
      >
        ...
        >
          {/* 🔥 אזור קליקים – מחלק כל שעה לשני סלוטים של 30 דק' */}
          {HOURS.map((h, idx) => {
            const baseTop = idx * slotHeight;
              ...
              <React.Fragment key={h}>
                ...
                <button
                  ...
                  style={{
                    top: baseTop,
                    height: slotHeight / 2,
                    // אפשר לשים פה hover עדין אם תרצה:
                    // backgroundColor: "transparent",
                  }}
                  onClick={() =>
                    handleCalendarSlotClick(
                      new Date(iso),     // תאריך של היום הנוכחי
                      time00,            // שעה
            ...
            hoverPreview.staffId === staff.id && (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 0 1px rgba(255,37,124,0.22) inset",
                }}
              >
