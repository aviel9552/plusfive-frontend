          ...
          <div className="relative z-20 flex-1 overflow-y-auto px-6 pt-2 pb-5 text-sm text-gray-800 dark:text-gray-100" dir="rtl">
            ...
            <div className="space-y-3">
              {filteredWaitlist.map((item) => (
                <div
                  key={item.id}
                  className="relative rounded-xl border border-gray-200 dark:border-[#282828] bg-white dark:bg-[#181818] p-3 text-[14px] text-gray-800 dark:text-gray-100 text-right flex-row-reverse"
                >
