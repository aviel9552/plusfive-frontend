        ...
        >
          ...
          <div className="relative z-20 flex-1 overflow-y-auto px-6 pt-2 pb-5 text-sm text-gray-800 dark:text-gray-100" dir="rtl">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4" dir="rtl">
              ...
              <div className="relative">
                <button
                  className="inline-flex items-center justify-between px-3 py-3 rounded-full border border-gray-200 dark:border-[#282828] bg-white dark:bg-[#181818] text-xs sm:text-sm text-gray-800 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-[#222]"
                  onClick={(e) => {
                    e.stopPropagation();
