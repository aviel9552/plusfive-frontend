...
<div className="px-8 py-5 border-t border-gray-200 dark:border-commonBorder">
  <button
    ...
    onClick={() => {
      ...
      // ניקוי וסגירת פאנל
      setIsWaitlistAddOpen(false);
      setWaitlistAddStep("date");   // אחרי Apply חוזר לחלק של תאריך כברירת מחדל
      setBookingSelectedTime("any");
      setBookingSelectedService(null);
      setServiceSearch("");
      setSelectedWaitlistClient(null);
...
const handleCreateNewClient = () => {
  ...
  const newClient = {
    id: Date.now(),
    name: newClientName,
    initials: newClientName[0]?.toUpperCase() || "?",
