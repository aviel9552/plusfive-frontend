  ...
  useEffect(() => {
    if (userDataProp && typeof userDataProp === 'object') {
      ...
      const newFormData = {
        ...
        phoneNumber: safeGetValue(userDataProp, 'phoneNumber') ? formatPhoneForDisplay(safeGetValue(userDataProp, 'phoneNumber')) : '',
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        const result = await dispatch(updateUser(userDataProp.id, dataToSend));
