...
function AdminAnalyticsMonthlyPerformance({ onLoadingChange }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (revenueCountsResponse && revenueCountsResponse.success && revenueCountsResponse.data) {
          setRevenueCountsData(revenueCountsResponse.data);
        } else {
          console.error('Invalid response structure:', revenueCountsResponse);
          setRevenueCountsData({});
        }
      } catch (error) {
  ...
  useEffect(() => {
    if (onLoadingChange) {
      const isLoading = monthlyPerformance.loading || revenueCountsLoading;
      onLoadingChange(isLoading);
    }
  }, [monthlyPerformance.loading, revenueCountsLoading, onLoadingChange]);
