    ...
    <div className="bg-gray-100 dark:bg-customBrown border border-gray-200 dark:border-gray-800 p-4 rounded-lg">
      ...
      <div className="mb-2">
        <div className="flex items-center">
          ...
          <span className="ml-2 text-xs border border-[#ffffff33] bg-gray-50 dark:bg-[#ffffff1a] text-gray-700 dark:text-white px-2 py-1 rounded">{t.twentyPercentOff}</span>
        </div>
