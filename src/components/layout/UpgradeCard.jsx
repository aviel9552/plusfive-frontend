...
const UpgradeCard = ({ onClose }) => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-customBrown border border-gray-200 dark:border-[#FFFFFF1A] p-4 rounded-lg">
      <div className="flex items-center mb-2 justify-between">
        <div className="mr-2 bg-white p-2 rounded-lg border-2 border-gray-200 dark:border-[#FFFFFF1A]">
      ...
      <div className="mb-2">
        <div className="flex items-center gap-2">
          <span className="font-medium text-gray-900 dark:text-white">{t.upgradePlan}</span>
          <span className="text-xs border border-[#ffffff33] bg-gray-50 dark:bg-[#ffffff1a] text-gray-700 dark:text-white px-2 py-1 rounded">{t.twentyPercentOff}</span>
        </div>
