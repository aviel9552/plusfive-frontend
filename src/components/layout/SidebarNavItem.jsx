...
const SidebarNavItem = ({
  ...
  const getIconClasses = () => {
    return 'text-22 lg:text-20 text-gray-800 dark:text-white';
  };
    ...
    if (customIcon) {
      if (
        ...
        return (
          <img
            src={iconSrc}
            alt=""
            className="w-5 h-5 lg:w-[24px] lg:h-[24px] brightness-0 dark:invert"
            style={{ filter: isDarkMode ? 'none' : 'brightness(0) saturate(100%) invert(20%)' }}
          />
        );
      }
      ...
      return (
        <img
          src={customIcon}
          alt=""
          className="w-5 h-5 lg:w-[20px] lg:h-[20px] brightness-0 dark:invert"
          style={{ filter: isDarkMode ? 'none' : 'brightness(0) saturate(100%) invert(20%)' }}
        />
      );
    }
