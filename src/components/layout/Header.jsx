...
const Header = ({ onMobileMenuToggle }) => {
  ...
  return (
    <header className={`bg-white dark:bg-customBlack px-4 lg:px-6 ${isRootPage ? 'h-[72px]' : 'h-[55px]': 'h-[55px] lg:h-[48px]'} grid border-b border-gray-200 dark:border-commonBorder font-ttcommons transition-colors duration-200`}>
