    ...
    <div className="">
      ...
      <div className="dark:bg-customBrown bg-white rounded-2xl border dark:border-[#FFFFFF1A] border-gray-200 dark:hover:bg-customBlack shadow-md hover:shadow-sm">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          <div className='md:p-8 p-0 dark:text-white text-black dark:bg-customBrown bg-customBody rounded-2xl md:border dark:border-[#FFFFFF1A] border-gray-200'>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full dark:bg-customBrown bg-white border dark:border-[#FFFFFF1A] border-gray-200 rounded-lg px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-pink-500 placeholder-gray-500 text-15"
                />
              </div>
          ...
          <div className='md:p-8 p-0 dark:text-white text-black dark:bg-customBrown bg-white rounded-2xl md:border dark:border-[#FFFFFF1A] border-gray-200'>
            <h2 className="text-22 font-medium mb-8">
              My QR Codes
            </h2>
            <div className="md:p-0 p-10 flex flex-col items-center justify-center h-[320px] rounded-lg dark:bg-customBrown bg-customBody border dark:border-[#FFFFFF1A] border-gray-200 border-dashed">
      ...
      <div className="dark:bg-customBrown bg-white rounded-2xl border dark:border-[#FFFFFF1A] border-gray-200 p-8 mt-8 dark:hover:bg-customBlack shadow-md hover:shadow-sm">
