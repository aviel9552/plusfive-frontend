                        ...
                        <div className="relative">
                          {selectedQR?.qrCodeImage ? (
                            <img
                              ...
                              className="w-24 h-24 object-contain border-4 border-white dark:border-commonBorder rounded-2xl shadow-lg"
                            />
                          ) : (
                            <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 border-4 border-white dark:border-commonBorder rounded-2xl flex items-center justify-center shadow-lg">
                              <MdQrCode2 className="w-12 h-12 text-gray-400 dark:text-gray-500" />
                            </div>
                          )}
                          <div className={`absolute -top-2 -right-2 w-6 h-6 rounded-full border-3 border-white dark:border-commonBorder flex items-center justify-center ${qrDetails.isActive ? 'bg-green-500' : 'bg-red-500'
                            }`}>
                            {qrDetails.isActive ? (
                  ...
                  <div className="overflow-x-auto">
                      ...
                      <tbody>
                            {qrDetails.scanDetails.map((scan, index) => (
                              <tr key={index} className="border-b border-gray-100 dark:border-commonBorder hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors">
