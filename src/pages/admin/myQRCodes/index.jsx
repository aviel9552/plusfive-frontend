          ...
          <div className="bg-white dark:bg-customBrown border border-gray-300 dark:border-customBorderColor rounded-2xl p-8 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            {loadingDetails ? (
              <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-2 text-gray-900 dark:text-white">Loading QR Code details...</span>
              </div>
            ) : qrDetails ? (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-gray-100 dark:bg-customBlack p-4 rounded-lg">
                    <h3 className="text-gray-700 dark:text-white text-sm">Chats Back</h3>
                    <p className="text-gray-900 dark:text-white text-2xl font-bold">{qrDetails.chatsBack || 0}</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-customBlack p-4 rounded-lg">
                    <h3 className="text-gray-700 dark:text-white text-sm">Friend Clicks</h3>
                    <p className="text-gray-900 dark:text-white text-2xl font-bold">{qrDetails.friendClicks || 0}</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-customBlack p-4 rounded-lg">
                    <h3 className="text-gray-700 dark:text-white text-sm">Shared Count</h3>
                    <p className="text-gray-900 dark:text-white text-2xl font-bold">{qrDetails.sharedCount || 0}</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-customBlack p-4 rounded-lg">
                    <h3 className="text-gray-700 dark:text-white text-sm">Total Scans</h3>
                ...
                <div className="bg-gray-100 dark:bg-customBlack p-6 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="text-gray-700 dark:text-white text-sm">URL</p>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-gray-300 dark:border-gray-700">
                          <th className="text-left py-2 text-gray-700 dark:text-gray-400">Referrer</th>
                          <th className="text-left py-2 text-gray-700 dark:text-gray-400">User-Agent</th>
                          <th className="text-left py-2 text-gray-700 dark:text-gray-400">IP</th>
                          <th className="text-left py-2 text-gray-700 dark:text-gray-400">When</th>
                          <th className="text-left py-2 text-gray-700 dark:text-gray-400">ID</th>
                        </tr>
                      </thead>
                      <tbody>
              ...
              <div className="text-center py-8">
                <p className="text-gray-600 dark:text-gray-400">No QR Code details available</p>
              </div>
            )}
          </div>
        </div>
