...
import { MdQrCode2, MdError, MdRefresh, MdContentCopy, MdDownload, MdCheckCircle } from 'react-icons/md';
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center p-8 max-w-md mx-4">
          <div className="w-20 h-20 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
            <MdError className="w-10 h-10 text-red-600 dark:text-red-400" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
            QR Code Error
          </h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center p-8 max-w-lg mx-4">
          ...
          <div className="flex items-center justify-center text-green-600 dark:text-green-400 mb-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <span className="text-sm font-medium">Scan recorded successfully! Analytics updated.</span>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-6 shadow-lg border-2 border-blue-200 dark:border-blue-800 mb-6">
            <div className="flex items-center justify-center mb-4">
              <FiExternalLink className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2" />
              <h3 className="text-xl font-semibold text-blue-900 dark:text-blue-100">
                Redirecting to Destination
              </h3>
            </div>
            
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-blue-200 dark:border-blue-700 mb-4">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 text-center">
                Target URL:
              </p>
              <p className="text-blue-600 dark:text-blue-400 break-all text-sm font-mono text-center bg-blue-50 dark:bg-blue-900/20 p-3 rounded border border-blue-200 dark:border-blue-700">
                {qrData.url}
              </p>
            </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center p-8 max-w-lg mx-4">
          ...
          {/* QR Code ID Display */}
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 shadow-lg border-2 border-purple-200 dark:border-purple-800 mb-6">
            <div className="flex items-center justify-center mb-4">
              <MdQrCode2 className="w-8 h-8 text-purple-600 dark:text-purple-400 mr-3" />
              <h3 className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                QR Code ID
              </h3>
            </div>
            
            <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border border-purple-200 dark:border-purple-700 mb-4">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 text-center">
                Your Unique Code:
              </p>
              <div className="text-center">
                <div className="inline-block bg-purple-100 dark:bg-purple-900/30 px-8 py-6 rounded-2xl border-2 border-purple-300 dark:border-purple-600">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 mb-6">
              ...
              {qrData.name && (
                <div className="mb-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <p className="text-gray-900 dark:text-white">{qrData.name}</p>
                </div>
              )}
              ...
              {qrData.messageForCustomer && (
                <div className="mb-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-blue-800 dark:text-blue-200">{qrData.messageForCustomer}</p>
                </div>
              )}
              ...
              {qrData.directMessage && (
                <div className="mb-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  ...
                  <p className="text-purple-800 dark:text-purple-200">{qrData.directMessage}</p>
                </div>
              )}
            </div>
          )}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
      <div className="text-center p-8 max-w-lg mx-4">
        <div className="w-20 h-20 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
          <MdQrCode2 className="w-10 h-10 text-blue-600 dark:text-blue-400" />
        </div>
        ...
        {qrData && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 mb-6">
              ...
              <div className="flex justify-center">
                {qrData.qrCodeImage ? (
                  <img 
                    ...
                    alt="QR Code" 
                    className="w-48 h-48 border-2 border-gray-300 dark:border-gray-600 rounded-lg shadow-lg"
                  />
                ) : (
                  <div className="w-48 h-48 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg shadow-lg flex items-center justify-center">
                    <div className="text-center">
                      <MdQrCode2 className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-2" />
            ...
            <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2 text-center">
                  🔑 QR Code Contains:
                </h4>
                <p className="text-blue-600 dark:text-blue-400 break-all text-sm font-mono text-center bg-white dark:bg-gray-800 p-3 rounded border border-blue-200 dark:border-blue-700">
                  {qrId}
                </p>
            ...
            {qrData?.url && (
              <div className="mb-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                <h4 className="font-medium text-green-900 dark:text-green-100 mb-2 text-center">
                  🎯 Target URL:
                </h4>
                <p className="text-green-800 dark:text-green-200 break-all text-sm font-mono text-center bg-white dark:bg-gray-800 p-3 rounded border border-green-200 dark:border-green-700">
                  {qrData.url}
                </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 mb-6">
          <div className="flex items-center justify-center mb-4">
            <MdQrCode2 className="w-6 h-6 text-green-600 dark:text-green-400 mr-2" />
        ...
        <div className="mt-8 text-xs text-gray-500 dark:text-gray-400">
          <p>QR Code ID: {qrId}</p>
          <p>Displayed at: {new Date().toLocaleString()}</p>
          {qrData?.url ? (
            <p className="text-blue-600 dark:text-blue-400 mt-2">
              💡 When scanned, users will be redirected to: <strong>{qrData.url}</strong>
            </p>
          ) : (
            <p className="text-blue-600 dark:text-blue-400 mt-2">
              💡 When scanned, users will see the code ID: <strong>{qrId}</strong>
            </p>
          )}
        </div>
      </div>
